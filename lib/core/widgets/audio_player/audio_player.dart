...
class TuiiAudioPlayer extends StatefulWidget {
  const TuiiAudioPlayer(
      ...
      this.controlIconSize = 64,
      this.downloadName = 'download.mp3'});
  ...
  @override
  State<TuiiAudioPlayer> createState() => _TuiiAudioPlayerState();
}

class _TuiiAudioPlayerState extends State<TuiiAudioPlayer>
...
class ControlButtons extends StatelessWidget {
  ...
  const ControlButtons(this.player, {Key? key, required this.iconSize})
      : super(key: key);
