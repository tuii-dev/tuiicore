...
/// card, button and divider builders, that check the for a  parent [TuiiContextMenuOverlay]
mixin ContextMenuStateMixin<T extends StatefulWidget> on State<T> {
  ...
  /// Shortcut call to [TuiiContextMenuOverlay].of(context)
  TuiiContextMenuOverlayState get overlay => TuiiContextMenuOverlay.of(context);
  ...
  Widget buildDivider() =>
      overlay.dividerBuilder?.call(context) ?? const ContextMenuDivider();
}