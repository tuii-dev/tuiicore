...
typedef ContextMenuButtonBuilder = Widget Function(BuildContext context, ContextMenuButtonConfig config,
...
class _ContextMenuButtonState extends State<ContextMenuButton> {
  ...
  Widget build(BuildContext context) {
    ...
    ContextMenuButtonStyle style = ContextMenuButtonStyle(
      ...
      hoverBgColor: widget.style?.hoverBgColor ?? Theme.of(context).colorScheme.background.withOpacity(.2),
