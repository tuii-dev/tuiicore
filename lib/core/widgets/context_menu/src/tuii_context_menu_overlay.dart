...
class TuiiContextMenuOverlay extends StatefulWidget {
  const TuiiContextMenuOverlay({
    Key? key,
    required this.child,
    this.cardBuilder,
    this.buttonBuilder,
  ...
  @override
  TuiiContextMenuOverlayState createState() => TuiiContextMenuOverlayState();

  static TuiiContextMenuOverlayState of(BuildContext context) =>
      (context.dependOnInheritedWidgetOfExactType<
              _InheritedContextMenuOverlay>() as _InheritedContextMenuOverlay)
          .state;
}

class TuiiContextMenuOverlayState extends State<TuiiContextMenuOverlay> {
...
class _InheritedContextMenuOverlay extends InheritedWidget {
  ...
  final TuiiContextMenuOverlayState state;
